...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def update_plots(self):
        ...
        #    print('adding data point ',self.fastdata.all_fields[key],' to ', key)
        #    self.data_filler.add_data_point(key,self.fastdata.all_fields[key])
        #print('all fields = ',self.fastdata.all_fields)
        #print('keys = ',self.fastdata.all_fields.keys())
        
        #print('self.plots = ',self.plots)
        #
        #
        self.data_filler.add_data_point('pressure',self.fastdata.p1[-1])
        self.data_filler.add_data_point('flow',self.fastdata.flow[-1])
        self.data_filler.add_data_point('volume',self.fastdata.vol[-1])
